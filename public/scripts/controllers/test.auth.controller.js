/*
This controller is for testing  testauth view not auth view
- currently this controller is for testing only
- this controller will have all routes run directly from it 
  to compare with routes running from the auth service on 
  the original auth view
*/
myApp.controller('TestAuthController', function ($http) {
